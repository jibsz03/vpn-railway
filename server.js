...
<head>
  ...
  <title>J1BTNL Config Generator | VLESS & Trojan</title>
      ...
      <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-5">
        <div class="flex items-center gap-4">
          ...
          <div>
            ...
            <h1 class="text-xl sm:text-2xl font-extrabold text-white">Config Generator</h1>
      ...
      <section class="glass rounded-3xl p-5 sm:p-6">
        ...
        <div class="space-y-4">
          ...
          <div class="soft rounded-2xl p-4">
            <p class="text-[11px] tracking-wider font-semibold text-slate-500 mb-3">SERVER OTOMATIS</p>
            <p id="server-host" class="uri text-sm text-slate-200 break-all"></p>
            <div class="flex gap-2 mt-4">
              <span class="rounded-lg bg-sky-500/10 border border-sky-400/20 text-sky-300 px-3 py-1.5 text-[11px] font-bold">PORT 443</span>
              <span class="rounded-lg bg-emerald-500/10 border border-emerald-400/20 text-emerald-300 px-3 py-1.5 text-[11px] font-bold">TLS</span>
              <span class="rounded-lg bg-violet-500/10 border border-violet-400/20 text-violet-300 px-3 py-1.5 text-[11px] font-bold">WS</span>
            </div>
          </div>
        </div>
      </section>
